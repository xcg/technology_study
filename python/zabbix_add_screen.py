#!/usr/bin/env python
#coding:utf-8
# 此脚本为zabbix官方创建screen脚本,官方地址为:https://www.zabbix.org/wiki/Python_script_to_create_Screen_from_all_Items/Graphs_of_a_host
# 使用方法为：python zabbix_add_screen.py '172.16.100.11' 'dbmaster01'  
# useage: python 脚本名 '主机地址' 'screen名' 
...
def main():
    ...
    url = 'http://172.16.100.10/zabbix/api_jsonrpc.php'
    username = "admin"
    password = "123456"    
